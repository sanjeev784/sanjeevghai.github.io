          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="aspect-square overflow-hidden border border-slate-200">
                <img
                  src="https://raw.githubusercontent.com/sanjeev784/sanjeevghai.github.io/main/DSC_0129.JPG"
                  alt={profile.name}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-6">
              ...
              <a href="https://researchgate.net/profile/Sanjeev-Ghai?ev=hdr_xprf&_tp=eyJjb250ZXh0Ijp7ImZpcnN0UGFnZSI6ImhvbWUiLCJwYWdlIjoiaG9tZSIsInBvc2l0aW9uIjoiZ2xvYmFsSGVhZGVyIn19" target="_blank" rel="noopener noreferrer" className="text-sm text-slate-500 hover:text-slate-900 transition-colors" data-testid="footer-researchgate">
                ResearchGate
              </a>
            </div>
          </div>
